...
with Session(bind=engine) as session:
    #123456 и qwerty
    u1=models.User(name="Малинина", mail="recipes228@mail.ru",img_avatar="http://127.0.0.1:8000/recipes/files/hah.jpg", password="$2b$12$/2gx.pO8GYYk7yASJfH3m.rYwOgaO/GvZ6Mzvqvyq.ZdT/mnZBpRS", mailing=False, email_verify=1) #пользователи
    u2=models.User(name="Хомяк", mail="recipes223@mail.ru",img_avatar="http://127.0.0.1:8000/recipes/files/hah.jpg", password="$2b$12$o3y6j3I0lS/MqDQ79AxSG.hZIBKC9JyYOUYeIaQh1lCsYeRWKzg9i", mailing=False, email_verify=1)
    ...
    r1=models.Recipe(name="Чизкейк", face_img="http://127.0.0.1:8000/recipes/files/hah.jpg", cooking_time=3, category=c3, user=u1, mealtime=[m1,m2],ingredient=[i1,i3]) #рецепты
